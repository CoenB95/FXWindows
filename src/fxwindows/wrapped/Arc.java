...
public class Arc extends ShapeBase {
	...
	public Arc() {
		...
		arc.layoutXProperty().bind(innerXProperty().add(radiusX.multiply(scaleXProperty())));
		arc.layoutYProperty().bind(innerYProperty().add(radiusY.multiply(scaleYProperty())));
